...
using Point.Of.Sale.Auth.Service.Command.AddRoleCommand;
using Point.Of.Sale.Auth.Service.Command.AddUserRoleCommand;
using Point.Of.Sale.Auth.Service.Command.DeleteRoleCommand;
using Point.Of.Sale.Auth.Service.Command.DeleteUserCommand;
using Point.Of.Sale.Auth.Service.Command.RegisterUser;
using Point.Of.Sale.Auth.Service.Command.RemoveUserRoleCommand;
using Point.Of.Sale.Auth.Service.Command.UpdateRoleCommand;
using Point.Of.Sale.Auth.Service.Query.GetRoles;
using Point.Of.Sale.Auth.Service.Query.GetUserRoles;
using Point.Of.Sale.Auth.Service.Query.GetUsers;
using Point.Of.Sale.Auth.Service.Query.UserExistQuery;
using Point.Of.Sale.Auth.Service.Query.ValidateUserQuery;
